package com.example.modulith.services.department.repository;
...
public interface DepartmentRepository extends CrudRepository<Department, Long> {
    ...
    @Query("""
            SELECT new com.example.modulith.services.department.DepartmentDTO(d.id, d.organizationId, d.name)
            FROM Department d
            WHERE d.id = :id
            """)
